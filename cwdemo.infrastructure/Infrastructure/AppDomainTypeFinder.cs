...
namespace cwdemo.infrastructure
{
    ...
    /// current  AppDomain. Only assemblies whose names matches
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        protected virtual void LoadMatchingAssemblies(string directoryPath)
        {
            ...
            foreach (var dllPath in files)
            {
                try
                {
                    ...
                    if (Matches(an.FullName) && Matches(an.Name) && !loadedAssemblyNames.Contains(an.FullName))
                    {
                        App.Load(an);
                    }
        ...
        /// <summary>Gets or sets whether App should iterate assemblies in the app domain when loading types. Loading patterns are applied when loading these assemblies.</summary>
